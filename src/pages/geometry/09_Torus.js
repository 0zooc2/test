...
export default class Torus {
	...
	_setupModel() {
		...
		const geometry = new THREE.TorusGeometry(0.9, 0.1, 12, 6, Math.PI); // 반지름 크기:1, 원기둥형태로 이걸 동그라게 말아놓은 모양이므로 이 띠의 반지름: 0.4, 토러스의 방사방향에 대한 분할 수: 8, 토러스 원통에 대한 분할 수: 8, 토러스의 표현할 각도: 2PI
